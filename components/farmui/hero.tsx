...
const ArcHero = () => {
    return (
      <section className="relative min-h-[calc(100vh-50px)] overflow-hidden bg-[linear-gradient(to_bottom,#fff,#b49de0_40%,#A46EDB_88%)]  dark:bg-[linear-gradient(to_bottom,#000,#200D42_40%,#4F21A1_74%,#A46EDB_88%_50%)] h-screen">
        ...
        <div className="dark:divide-dark-border relative z-10 flex flex-col divide-y divide-white/10 pt-[35px] absolute top-[7rem]">
          <div className="flex flex-col items-center justify-end">
            <div className="dark:border-dark-border flex items-center gap-2 !border !border-b-0 border-white/5 px-4 py-2 mt-[4rem]">
          ...
          <div>
            <div className="mx-auto flex h-[288px] max-w-[80vw] shrink-0 flex-col items-center justify-center gap-2 px-2 py-4 sm:px-10 lg:px-24">
              <h1 className="text-text-primary dark:text-dark-text-primary text-pretty text-center text-4xl  sm:text-5xl md:text-6xl  lg:text-[clamp(50px,7vw,75px)] font-medium leading-none tracking-[-1.44px] md:max-w-screen-lg md:tracking-[-2.16px]">
                building tomorrow's innovations today at arclabs
              </h1>
              <h2 className="text-md text-text-tertiary dark:text-dark-text-tertiary max-w-2xl text-pretty text-center md:text-lg">
                ArcLabs is a creative tech agency driven by an indie hacker’s
                passion for building exciting and groundbreaking projects.
                Explore our work that pushes the boundaries of web and
          ...
          <div className=" dark:divide-dark-border flex items-start justify-center divide-y divide-white/10  px-8 sm:px-24">
            <div className="flex w-full max-w-[80vw] flex-col items-center justify-start md:!max-w-[392px]">
              <div className="dark:border-dark-border flex items-center gap-2 !border border-b-0 border-white/5 px-4 py-2 mt-[4rem]">
                <p className="text-text-tertiary dark:text-dark-text-tertiary text-sm tracking-tight">
                  opening soon to showcase our work
                </p>
              </div>
          ...
          <div className="mx-auto max-w-7xl">{/* <AnimatedLogoCloud /> */}</div>
        </div>
      </section>
    );
}
