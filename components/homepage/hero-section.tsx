...
export default function HeroSection() {
    return (
        <section className='flex flex-col items-center justify-center leading-6 mt-[3rem]' aria-label="ArcLabs Hero">
                ...
                <div className="relative flex max-w-6xl justify-center overflow-hidden mt-7">
                    <div className="relative rounded-xl">
                        ...
                        <Image
                            ...
                            width={1100}
                            height={550}
                            alt="ArcLabs Dark Mode Dashboard Preview"
                            priority={true}
